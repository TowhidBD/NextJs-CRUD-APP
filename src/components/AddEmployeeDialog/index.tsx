...
const AddEmployeeDialog = ({ onShow, onHide, setSubmitted, setUserDialog }: IProps) => {
    ...
    return (
        <Dialog visible={onShow} style={{ width: '450px' }} header="Employee Details" modal className="p-fluid" onHide={onHide}>
            ...
            <div className="py-5">
                <Form onSubmit={onSubmit} initialValues={{ firstname: '', lastname: '', email: '', salary: '', status: '', birthDate: null }} validate={validate} render={({ handleSubmit }) => (
                    <form onSubmit={handleSubmit} className="p-fluid">
                        ...
                        <div className="flex justify-end mt-6">
                            <div className="flex gap-2 w-60">
                                ...
                                <Button label="Add" icon="pi pi-check" className="p-button-success p-button-sm" loading={isLoading} />
                            </div>
                        </div>
                    </form>
                )} />
